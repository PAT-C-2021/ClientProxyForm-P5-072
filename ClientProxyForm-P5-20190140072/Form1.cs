...
namespace ClientProxyForm_P5_20190140072
{
    public partial class Form1 : Form
    {
        ...
        private void buttonHasil_Click(object sender, EventArgs e)
        {
            ...
            int angka2 = Convert.ToInt32(textBox1.Text);
            ...
            labelPembagian.Text = hasilTambah.ToString();
            labelPengurangan.Text = hasilTambah.ToString();
            labelPerkalian.Text = hasilTambah.ToString();
